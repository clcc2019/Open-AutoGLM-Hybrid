...
INSTRUCTIONS = [
    ...
    "3. 买家提问时，必须优先从 skill 知识库中查找匹配答案，直接给出具体回答",
    "4. 对于知识库中已有明确答案的问题，不要反问买家，直接回答",
    "5. 遇到议价要有策略：先用 classify_intent 判断意图，再用 evaluate_bargain 评估出价",
    "6. 遇到敏感关键词（投诉、举报等）用 check_escalation 检查，必要时建议转人工",
    "7. 记住买家的偏好和历史对话，提供个性化服务",
    "",
    "## 回复风格",
    "- 用口语化的中文，适当用「～」「😊」等让对话更亲切",
